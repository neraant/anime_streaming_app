			...
			<form onSubmit={handleSubmitSignInForm} className='flex flex-col items-center w-full flex-none'>
				...
				<div className="flex flex-col gap-4 md:gap-6 w-full mt-4 md:mt-8 max-w-100">
					...
					<div className="">
						...
						<div className="flex flex-col mt-2 ml-2 gap-[2px]">
				...
				<button 
					type="submit"
					className={`mt-5 w-full text-white text-sm md:text-base bg-purple-500 rounded-full py-2 md:py-3 font-semibold cursor-pointer transition-all duration-300 hover:bg-purple-800 max-w-100 flex justify-center items-center gap-3 ${emailMutation.isLoading && "bg-purple-800"}`	}
